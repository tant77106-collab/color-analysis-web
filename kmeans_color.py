...
def extract_colors(image_path):
    ...
    # ชดเชยกรณีปัดแล้วไม่ครบ 100
    if printed_total != 100:
        adjust = round(100 - printed_total, 2)
        raw[0]["printed"] = round(raw[0]["printed"] + adjust, 2)
        printed_total = 100.0

    # เรียงจากพื้นที่มาก → น้อย
